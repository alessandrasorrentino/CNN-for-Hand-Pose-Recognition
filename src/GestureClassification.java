...
public class GestureClassification {
    protected static final Logger log = LoggerFactory.getLogger(GestureClassification.class);
    protected static int height = 32;
    protected static int width = 32;
    protected static int channels = 1;
    protected static int numExamples = 192;
    protected static int numLabels = 4;
    protected static int batchSize = 24;

    protected static long seed = 50;//42;
    protected static Random rng = new Random(seed);
    protected static int listenerFreq = 1;
    protected static int iterations = 1;
    protected static int epochs = 80;
    ...
    public void run(String[] args) throws Exception {
        ...
        File mainPath = new File(System.getProperty("user.dir"), "src/main/resources/gestures/");
      ...
      //  ImageTransform resizeTransform = new ResizeImageTransform(80,80);
       // ImageTransform rotationTransform = new RotateImageTransform(45);
        ...
        List<ImageTransform> transforms = Arrays.asList(new ImageTransform[]{flipTransform1, warpTransform,scaleTransform4, flipTransform2,scaleTransform6,scaleTransform1,resizeTransform2,
...
//        MultiLayerNetwork network = new AlexNet(height, width, channels, numLabels, seed, iterations).init();
    ...
    public MultiLayerNetwork customModel(){
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                .miniBatch(false)
                .list()
                .layer(0, convInit("cnn1", channels, 20, new int[]{5, 5}, new int[]{1, 1}, new int[]{4, 4}, nonZeroBias))
                //.layer(1, new LocalResponseNormalization.Builder().name("lrn1").build())
                .layer(1, maxPool("maxpool1", new int[]{2,2}))
                .layer(2,conv5x5("cnn2", 20,new int[]{5,5},new int[]{1,1},0))
                //.layer(4, new LocalResponseNormalization.Builder().name("lrn2").build())
                .layer(3, maxPool("maxpool2", new int[]{2,2}))
                .layer(4,conv3x3("cnn3", 20, nonZeroBias))
    ...
    public static void main(String[] args) throws Exception {
        new GestureClassification().run(args);
    }
